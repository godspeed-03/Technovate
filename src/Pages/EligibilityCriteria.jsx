...
function EligibilityCriteria() {
  ...
  return (
    <div className="z-10 w-screen flex justify-center items-center py-16">
      <div className="rounded-xl  p-14 w-[60%] h-auto border-2 border-white  flex gap-10 text-white">
      <div className="gif flex  items-center justify-center">
        ...
        <div className="content  flex flex-col items-start justify-center gap-10">
          <h1 class="font-bold text-xl text-white">Feature List</h1>
          <ul class="mt-3 flex flex-col space-y-2">
            ...
            <li class="flex">
              ...
              <p class="text-base text-white sm:text-lg">Easy to use</p>
            </li>
            <li class="flex">
              <svg
                xmlns="http://www.w3.org/2000/svg"
