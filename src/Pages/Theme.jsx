...
<div className="flex gap-10">
    ...
    <a class="relative" href="#">
        ...
        <span class="fold-bold relative inline-block h-full w-full rounded border-2 border-white bg-white px-3 py-1 text-base font-bold text-black transition duration-10 hover:bg-blue-500 dark:bg-transparent">elevated button</span>
    </a>
    <a href="#" class="relative">
        <span class="absolute top-0 left-0 mt-1 ml-1 h-full w-full rounded bg-blue-500"></span>
        <span class="fold-bold relative inline-block h-full w-full rounded border-2 border-white bg-blue-500 px-3 py-1 text-base font-bold text-black transition duration-100 hover:bg-white dark:bg-transparent">elevated button filled</span>
    </a>
</div>
          </div>
    </div>
