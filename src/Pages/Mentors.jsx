...
import animationData from "../assets/Mentors.json";
import {
  Accordion,
  AccordionItem,
              ...
              <div className="flex max-lg:flex-col flex-row gap-10">
                ...
                <div className="content  flex flex-col items-start justify-center gap-10">
                  <p className="font-content font-light max-md:text-sm max-lg:text-center">
                    ​Our Mentors are not just experts; they're visionaries who
            ...
            <div className="faq flex flex-col gap-5">
              ...
              <Accordion>
                ...
                <AccordionItem>
                  ...
                  <AccordionItemPanel>
                    <p className="font-content font-light max-md:text-sm max-lg:text-center">
                      ...
                      Mentors will be present at the final rounds of the
                ...
                <AccordionItem>
                  <AccordionItemHeading className="font-Heading font-medium max-md:text-sm max-lg:text-center">
                    <AccordionItemButton>
                      Will Mentors receive compensation for their judging and
                      guidance?
                    </AccordionItemButton>
                  </AccordionItemHeading>
                  <AccordionItemPanel>
